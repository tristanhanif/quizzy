  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-1">Siap untuk quiz berikutnya?</p>
        {user?.displayId && (
          <div className="mt-2 inline-flex items-center gap-1.5 rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-mono">
            <svg className="h-3.5 w-3.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0" />
            </svg>
            <span className="text-gray-500">ID: {user.displayId}</span>
          </div>
        )}
      </div>
